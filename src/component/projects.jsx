	...
	render() {
		return (
			<React.Fragment>
									...
									<div>
										<button
											...
											onClick={() => {
												...
												var carHubModal = document.getElementById(
													"carHub"
												);
												modalBG.style.display = "block";
												carHubModal.style.display =
													"block";
											}}>
											Learn More
										</button>
									...
									<div>
										<button
											...
											onClick={() => {
												...
												var projectModal = document.getElementById(
													"project"
												);
												modalBG.style.display = "block";
				...
				{/*hidden modals*/}
				<div id="gallery-card">
					<div id="CarHub" className="modal-card">
							...
							<div className="modal-bottom">
								...
								<p
									...
									onClick={() => {
										...
										carHubModal.style.display = "none";
									}}>
									&#10005;
								</p>
							</div>
